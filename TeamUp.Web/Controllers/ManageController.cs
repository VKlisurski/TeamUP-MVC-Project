namespace TeamUp.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            var code = await this.UserManager.GenerateChangePhoneNumberTokenAsync(User.Identity.GetUserId(), model.Number);
            var result = await this.UserManager.ChangePhoneNumberAsync(User.Identity.GetUserId(), model.Number, code);
            ...
            if (result.Succeeded)
            {
                ...
                return this.RedirectToAction("Index", new { Message = ManageMessageId.ChangedPhoneSuccess });
            }

            return this.RedirectToAction("Index", new { Message = ManageMessageId.ChangedPhoneFailed });
        }
